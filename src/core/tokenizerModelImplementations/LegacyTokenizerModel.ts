...
import { TokenizerModelConfigLegacy } from "@static/tokenizer";
...
class LegacyTokenizerModel extends TokenizerModel {
   ...
   * @param config The configuration object for LegacyTokenizerModel.
   * @param more_config Additional configuration object for the LegacyTokenizerModel model.
   */
  constructor(
...
export default LegacyTokenizerModel;
